 ...
 *
 * Runtime parity compares this string across Ptah, Luna and Pehlichi. If the three agents do not
 ...
 */
export const CONTAINMENT_VERSION = "1.2.0";
 ...
 */
export const CONTAINMENT_CONTRACT_VERSION = "1.1.0";
